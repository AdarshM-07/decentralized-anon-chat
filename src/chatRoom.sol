...
contract Chatroom {
    ...
    function createMessage(string memory _content, string memory _name) public notpause {
    ...
    function createMessage(string memory _content, string memory _name, address fundmeAdd) public notpause {
        Message newMessage = new Message(_content, _name, 0, fundmeAdd);
        address messageAdd = address(newMessage);
        chats.push(chatMessage(messageAdd));
    }

    function createFutureMessage(string memory _content, string memory _name, uint256 _daysToSend) public notpause {
    ...
    function createFutureMessage(string memory _content, string memory _name, uint256 _daysToSend, address fundmeAdd)
        public
        notpause
    {
